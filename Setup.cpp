...
bool setup(){
  ...
  MAIN_CHARACTER_DESK_SPAWN_Y = 76*SCALESIZE;
  ...
  COWORKER_SPAWN_Y = 68*SCALESIZE;

  COWORKER_COMPUTER_X = OFFSET + 86*SCALESIZE;
  COWORKER_COMPUTER_Y = 68*SCALESIZE;
